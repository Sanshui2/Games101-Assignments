...
namespace rst
{
    ...
    public:
        ...
        inline int sample_index(int x, int y, int sx, int sy)const {return (y * width + x) * 4 + (sy * 2 + sx); }
    ...
    private:
        ...
        std::vector<Eigen::Vector3f> ssaa_color;//每个子样本的颜色
		std::vector<float> ssaa_depth;//每个子样本的深度
